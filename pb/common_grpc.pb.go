...
type KeepAliveClient interface {
	Check(ctx context.Context, in *KeepAliveRequest, opts ...grpc.CallOption) (*KeepAliveResponse, error)
}
...
func (c *keepAliveClient) Check(ctx context.Context, in *KeepAliveRequest, opts ...grpc.CallOption) (*KeepAliveResponse, error) {
	out := new(KeepAliveResponse)
	err := c.cc.Invoke(ctx, "/pb.KeepAlive/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KeepAliveServer interface {
	Check(context.Context, *KeepAliveRequest) (*KeepAliveResponse, error)
...
func (UnimplementedKeepAliveServer) Check(context.Context, *KeepAliveRequest) (*KeepAliveResponse, error) {
...
func _KeepAlive_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KeepAliveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KeepAliveServer).Check(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.KeepAlive/Check",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeepAliveServer).Check(ctx, req.(*KeepAliveRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _KeepAlive_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pb.KeepAlive",
	HandlerType: (*KeepAliveServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Check",
			Handler:    _KeepAlive_Check_Handler,
		},
	},
